                            ...
                            <form method="POST" action="?page=dhcpd_conf">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="RangeStart"
                                               value="<?php echo $RangeStart; ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="RangeEnd"
                                               value="<?php echo $RangeEnd; ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-xs-2 col-sm-2">
                                        ...
                                        <input type="text" class="form-control" name="RangeLeaseTime"
                                               value="<?php echo $arrRangeLeaseTime[1]; ?>"/>
                                    </div>
                                ...
                                <input type="submit" class="btn btn-outline btn-primary" value="Save settings"
